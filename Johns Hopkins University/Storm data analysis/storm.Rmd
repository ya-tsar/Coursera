...
#Loadind Storm data
data_path <- "https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2FStormData.csv.bz2"

setAs("character","myDate", function(from) as.Date(from, format="%m/%d/%Y %H:%M:%S"))

data <- read.table(data_path,                 
                   colClasses = c("BGN_DATE" = "myDate",                                  
                                  "WFO" = "character",
                                  "END_TIME" = "character",
                                  "BGN_AZI" = "character",
                                  "BGN_LOCATI" = "character",
                                  "END_DATE" = "character",
                                  "CROPDMGEXP" = "character",
                                  "ZONENAMES" = "character",
                                  "REMARKS" = "character",
                                  "END_LOCATI" = "character",
                                  "END_AZI" = "character",
                                  "STATEOFFIC" = "character")) 
